...
include 'db.php';
$journal_sql="SELECT id,volume,issue,page_start FROM tbl_publication where status = '1' GROUP BY volume, issue ORDER BY id";
        ...
        <div class="container pad-bot-70">
            <div class="row">
                ...
                if($volume == '106') continue;
                                ...
                                <div class="s17-eve-time">
                                    ...
                                    <div class="s17-eve-time-msg">
                                        <?php foreach($issues as $index => $issue){
                                            if($volume == $current_volume && $issue == $current_issue){
                                                continue;
                                            }
                                        ?>
                                        <div class="event-head-sub">
                    ...
                    <div class="event-head-sub">
                                            <ul>
                                                <li><a href="106/june-special.php">Special</a></li>
                                            </ul>
                                        </div>
                    <div class="event-head-sub">
                                            <ul>
