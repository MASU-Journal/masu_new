...
include_once('../db.php');
//pre($_SESSION,1);
if(empty($_SESSION['admin_login']) || empty($_SESSION['role_id']) || $_SESSION['admin_login'] != 'yes' || $_SESSION['role_id'] != '7'){
...
<head>
        ...
        <title>MASU Journal - Press</title>
    ...
    <body>
        ...
        <?php include_once('press_sidebar.php'); ?>
