...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, reviewer_author_file, 	chief_author_file, resubmitted FROM tbl_journal WHERE user_id = '".$_SESSION['user_id']."' AND status='10'");
  ...
  margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
              ...
              <ol class="breadcrumb">
                  ...
                  <li class="item">Approved & Published Manuscripts</li>
              </ol>
            </div>
