...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, reviewer_author_file, 	chief_author_file, resubmitted FROM tbl_journal WHERE user_id = '".$_SESSION['user_id']."' AND status='3'");
...
.j-btn-section{
  margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
              <h1>Withdrawn Manuscripts</h1>
              <ol class="breadcrumb">
                  <li class="item"><a href="dashboard.php"><i class='bx bx-home-alt'></i></a></li>
                  <li class="item">Cancelled Manuscripts by Author</li>
              </ol>
            </div>
