...
if (strpos($_SERVER['REQUEST_URI'],'e-view-journal') !== false) {
...
if(empty($_SESSION['admin_login']) || empty($_SESSION['role_id']) || $_SESSION['admin_login'] != 'yes' || ($_SESSION['role_id'] != '1' && $_SESSION['role_id'] != '2' && $_SESSION['role_id'] != '3' && $_SESSION['role_id'] != '6')){
...
<head>
    ...
    <title>MASU Journal - Editor</title>
...
<body>
    ...
    <?php include_once('editor-sidebar.php'); ?>
