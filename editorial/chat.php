...
if(!empty($_GET['ref'])){
    ...
    $journal_qry = $db->query("SELECT id, title, user_id, status, manuscript_id, resubmitted FROM tbl_journal WHERE manuscript_id = '$manuscript_id' AND user_id = '".$_SESSION['user_id']."'");
...
//pre($c_data,1);
// if(!empty($que_qry->rows)){
//   foreach($que_qry->rows as $key => $row){
        ...
        <ol class="breadcrumb" style="width: 100%;">            
            <li class="item text-right" style="width: 100%;">
                <form action="#" method="get" style="width: 100%;">
                    <input placeholder="Please enter Manuscript ID to see the comments" class="col-md-8 form-control d-inline-block" type="text" name="ref" id="manuscript_id" value="<?php echo $manuscript_id; ?>">
                    ...
                    $(".send-btn").click(function(){
                        ...
                        $.ajax({
                            ...
                            success : function(response){
                                ...
                                $("#comment_"+q_id).val("");
                                if(response == '1'){
                                    var chat_content = '<div class="chat"><div class="chat-avatar"><a href="#" class="d-inline-block"><img src="assets/img/author.png" width="50" height="50" class="rounded-circle" alt="image"></a></div><div class="chat-body"><div class="chat-message"><p>'+comment+'</p><span class="time d-block"></span></div></div></div>';
