...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, reviewer_author_file, 	chief_author_file, resubmitted, added_date FROM tbl_journal WHERE user_id = '".$_SESSION['user_id']."' AND resubmitted='0' AND status IN ('0','1','11','12')");
...
.j-btn-section{
  margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
                <h1>Manuscripts under Quality Check </h1>
                <ol class="breadcrumb">
   ...
   <?php }
            ...
            <div class="card mb-30" style="display: block;min-height:300px;">
              <div class="mt-30 card-header d-flex justify-content-between align-items-center journal-title" style="text-align: center;margin-top:80px;">
                  <h3>No Articles in Quality check status right now..!</h3>
              </div>                
            </div>
