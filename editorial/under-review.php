...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, reviewer_author_file, 	chief_author_file, resubmitted FROM tbl_journal WHERE user_id = '".$_SESSION['user_id']."' AND resubmitted='0' AND status IN ('5','6','8')");
  ...
  margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="item">Review Section</li>
                </ol>
            </div>
