...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, resubmitted FROM tbl_journal WHERE status='0' AND resubmitted > 0");
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-10 text-right">
                          <span class="text-right">
                            <a href="chat-manager.php?ref=<?php echo $data->manuscript_id; ?>">
