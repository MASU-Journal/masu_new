...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, resubmitted FROM tbl_journal WHERE status='5' AND resubmitted > 0");
            ...
            <div class="card mb-30" style="display: block;padding: 0px;">
                ...
                <div class="card-body" style="padding: 10px 25px;">
                    <div class="row journal-info">
                      ...
                      <div class="col-md-2">
                        <span class="text-justify no-margin">
                          <span class="sub-title">Re-Assigned to : </span>
                        </span>
                      </div>
                      <div class="col-md-10">
                          <span class="text-justify no-margin">
                    ...
                    <?php if(!empty($assigned_dates[$data->id])){ ?>
                      <div class="row">
                        <div class="col-md-2">
                          <span class="text-justify no-margin">
                            <span class="sub-title">Re-Assigned Date : </span>
                          </span>
                        </div>
                        <div class="col-md-10">
                            <span class="text-justify no-margin">
