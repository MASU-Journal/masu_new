...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, reviewer_author_file, 	chief_author_file, resubmitted FROM tbl_journal WHERE user_id = '".$_SESSION['user_id']."' AND status IN ('5','6','8')");
  ...
  margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
              ...
              <ol class="breadcrumb">
                  ...
                  <li class="item">Revised Manuscripts - Review Section</li>
              </ol>
            </div>
   ...
   <?php }
            ...
            <div class="card mb-30" style="display: block;min-height:300px;">
              <div class="mt-30 card-header d-flex justify-content-between align-items-center journal-title" style="text-align: center;margin-top:80px;">
                  <h3>No articles in review section right now..!</h3>
              </div>                
            </div>
