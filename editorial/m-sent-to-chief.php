...
$journal_data = $db->query("SELECT id, title, author, affiliation, subject, type, year, status, manuscript_id, resubmitted FROM tbl_journal WHERE status IN ('1') AND resubmitted ='0' ");
      ...
      margin : 20px 30px;
            ...
            <div class="breadcrumb-area">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="item">Sent to chief</li>
                </ol>
            </div>
